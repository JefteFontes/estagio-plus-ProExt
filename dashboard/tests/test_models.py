...
from dashboard.models import Endereco, Instituicao, CoordenadorExtensao, Empresa, Cursos, Estagiario, Supervisor, Estagio, ImportTermoEstagio
...
class TestModels(TestCase):
    ...
    def test_criar_endereco(self):
        endereco = Endereco.objects.create(
            rua="Rua Teste", numero="123", bairro="Centro", cidade="Cidade Teste", estado="Estado Teste", cep="12345678"
        )
    ...
    def test_criar_instituicao(self):
        ...
        instituicao = Instituicao.objects.create(
            cnpj="12345678000199", nome="Instituição Teste", email="instituicao@test.com", telefone="1234567890"
        )
    ...
    def test_criar_empresa(self):
        ...
        instituicao = Instituicao.objects.create(
            cnpj="12345678000199", nome="Instituição Teste", email="instituicao@test.com", telefone="1234567890", endereco=endereco
        )
    ...
    def test_criar_cursos(self):
        ...
        curso = Cursos.objects.create(
            instituicao=instituicao, nome_curso="Curso Teste", descricao="Descrição Teste", area="Tecnologia", coordenador="Coordenador Teste", email_coordenador="coordenador@test.com"
        )
    ...
    def test_criar_estagiario(self):
        ...
        estagiario = Estagiario.objects.create(
            primeiro_nome="Estagiário", sobrenome="Teste", cpf="12345678901", matricula="123456", email="estagiario@test.com", telefone="1234567890", curso=curso, status=False
        )
    ...
    def test_criar_estagio(self):
        ...
        estagio = Estagio.objects.create(
            area="Desenvolvimento", tipo_estagio="Não obrigatório", status="Em andamento", descricao="Estágio Teste", data_inicio=date.today(), data_fim=date.today() + timedelta(days=30),
            estagiario=estagiario, empresa=empresa, instituicao=instituicao
        )
