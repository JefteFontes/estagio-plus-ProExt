...
from mais_estagio.views.relatorios import (
    relatorios,
    verificar_relatorios_pendentes,
    importar_termo_relatorio,
)
from mais_estagio.views.personalizados import (
    dashboard_personalizados,
    relatorio_personalidizado,
)
from mais_estagio.views.orientador import (
    cadastro_orientador,
    dashboard_orientador,
    relatorios_orientador,
)
from mais_estagio.views.supervisor import (
    cadastro_supervisor,
    dashboard_supervisor,
    relatorios_supervisor,
)
...
urlpatterns = [
    ...
    path("cadastro-instituicao", cadastrar_instituicao, name="cadastro_instituicao"),
    # Aluno URLs
    path("cadastro/", cadastro_aluno, name="cadastro_aluno"),
    path("dashboard/estagios-aluno/", estagios_aluno, name="estagios_aluno"),
    path("aluno/estagio-andamento/", estagio_andamento, name="estagio_andamento"),
    path(
        "dashboard/estagio/<int:pk>/",
        detalhes_estagio_aluno,
        name="detalhes_estagio_aluno",
    ),
    ...
    path(
        "estagio/<int:estagio_id>/download-tceu/", download_tceu, name="download_tceu"
    ),
    ...
    path(
        "editar_estagiario/<int:estagiario_id>",
        editar_estagiario,
        name="editar_estagiario",
    ),
    path(
        "deletar_estagiario/<int:estagiario_id>",
        deletar_estagiario,
        name="deletar_estagiario",
    ),
    path(
        "estagiario/cadastro/<uuid:token>/",
        estagiario_auto_cadastro,
        name="estagiario_auto_cadastro",
    ),
    ...
    path(
        "cadastrar_supervisor/<int:empresa_id>/",
        cadastro_supervisor,
        name="cadastrar_supervisor",
    ),
