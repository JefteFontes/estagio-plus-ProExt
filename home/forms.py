...
class CoordenadorCadastroForm(forms.ModelForm):
    ...
    complemento = forms.CharField(max_length=200, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Complemento'}), required=False)
    ...
    def clean_cpf(self):
        ...
        if not validate_cpf(cpf):  # Valida CPF depois de limpar
            raise forms.ValidationError("CPF inválido. Use um CPF válido com 11 dígitos.")
